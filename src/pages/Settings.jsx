...
const Settings = ({ bonusTime, setBonusTime, theme, setTheme }) => {
  ...
  return (
    <Layout>
      {/* Header */}
      <div className="bg-white/50 dark:bg-slate-900/80 backdrop-blur-md sticky top-0 z-20 px-4 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center gap-4">
